...
<div class="my-3 w-full">
	...
	<div>
		...
		<p>
			...
			Ihrer angegebenen pers&#246;nlichen Daten mit Wirkung f&#252;r die Zukunft widerrufen.<br />
	...
	<div class="mt-8 text-lg">
		...
		<p>
			...
			Betriebssystem und Ihren Internet Service Provider.
		</p>
		<p class="mt-4">
			Diese Daten lassen keinerlei R&#252;ckschl&#252;sse auf Ihre Person zu und werden von uns
			statistisch ausgewertet, um unseren Internetauftritt technisch und inhaltlich zu verbessern.
			Das Erfassen dieser Informationen ist notwendig, um den Inhalt der Webseite korrekt ausliefern
			zu k&#246;nnen.
		</p>
		<p class="mt-4">
		...
		<p class="mt-4">
			...
			bestehende Gesch&#228;ftsbeziehungen bzw. es liegt Ihnen eine entsprechende Einwilligung von
			uns vor.
		</p>
		<p class="mt-4">
	...
	<div class="mt-8">
		...
		<p>
			...
			sind wir als Diensteanbieter jedoch nicht verpflichtet, &#252;bermittelte oder gespeicherte
		...
		<p>
			...
			Gew&#228;hr&#252;bernommen werden. F&#252;r die Inhalte der verlinkten Seiten ist stets der
			...
			Rechtsverletzung nicht zumutbar. Bei Bekanntwerden von Rechtsverletzungen werden derartige
			Links umgehend von dieser Website auf die rechtsverletzende Site entfernen.
		</p>
		<h3 class="mt-4">3. Urheberrecht</h3>
		Die durch die Diensteanbieter, deren Mitarbeiter und beauftragte Dritte erstellten Inhalte und Werke
		...
		der vorherigen schriftlichen Zustimmung des jeweiligen Autors bzw. Erstellers. Downloads und Kopien
	...
	<div class="mt-20 border-t-2 border-slate-300 text-center">
		<p class="mt-4">
			Diese Seite wurde mit Hilfe des <a
				target="_blank"
