<script lang="ts">
	...
	import { EditMode, EditModeStore, NewsItemsStore, type Event } from '$lib/stores/ObjectStore';
	...
	<form enctype="multipart/form-data" on:submit={handleSubmit} on:reset={handleReset}>
		...
		<div class="form bg-white-primary p-10">
			...
			<div class="buttons col-span-2">
				...
				>
				<button class="button btn-secondary" type="reset">Empty form</button>
				<button class="button btn-primary" type="submit" disabled={newEvent.title.length === 0}
