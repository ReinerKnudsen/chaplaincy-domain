	...
	<div class="flex flex-col gap-10">
			...
			<div class="flex flex-row items-center justify-start gap-10">
				<div class="w-1/2">
					...
					<p>
						deutsch: <a
							class="link"
							href="https://w3w.co/lilien.postkarte.angehängt"
							target="_blank">///lilien.postkarte.angehängt</a
						>
					</p>
				...
				<div class="flex flex-col items-end">
					...
					></iframe><small
						><a
							href="https://www.openstreetmap.org/?mlat=50.741695&amp;mlon=7.132289#map=19/50.741694/7.132287"
							>View Larger Map</a
						></small
					>
				</div>
		...
		<div>
			...
			<div class="flex flex-row items-center justify-start gap-10">
				<div class="w-1/2">
					...
					<h4 class="mt-6">What3Words</h4>
					<p>
						english: <a class="link" href="https://w3w.co/mental.diplomat.uses" target="_blank"
							>///mental.diplomat.uses</a
						>
					</p>
					<p>
					...
					<h4 class="mt-6">Public transport</h4>
					<p>Bus 132 (Meschenich) to Arnoldshöhe</p>
					<p>exit at Pantheon Beuel</p>
				</div>
				<div class="flex flex-col items-end">
					<iframe
					...
					></iframe><small
						><a
							href="https://www.openstreetmap.org/?mlat=50.894324&amp;mlon=6.967759#map=19/50.894325/6.967761"
							>View Larger Map</a
						></small
					>
				</div>
		...
		<div class="flex flex-col">
			...
			<div class="mt-4">
				<a
					class="calltoaction"
					href="https://us02web.zoom.us/j/5420448085?pwd=MFVnM1QzTzRsODZEaHVEUU9qZHpVdz09"
					target="_blank">Join us online</a
				>
			</div>
		</div>
	</div>
