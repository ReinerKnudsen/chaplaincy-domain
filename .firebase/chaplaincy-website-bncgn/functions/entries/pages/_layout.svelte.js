import { c as create_ssr_component, f as compute_rest_props, k as setContext, h as spread, j as escape_attribute_value, i as escape_object, a as add_attribute, g as getContext, e as escape, s as subscribe, v as validate_component } from "../../chunks/ssr.js";
...
const Navigation = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Navbar, "Navbar").$$render(
    $$result,
    {
      class: "sticky top-0 z-20 w-full border-b px-2 py-2.5 sm:px-4"
    },
    {},
    {
      default: () => {
        return `${validate_component(NavBrand, "NavBrand").$$render($$result, { href: "/" }, {}, {
          default: () => {
            return `<img src="/src/lib/assets/chaplaincy_logo.png" class="me-3 h-6 sm:h-9" alt="Flowbite Logo"> <span class="text-md self-center whitespace-nowrap font-semibold dark:text-white" data-svelte-h="svelte-1erji7r">Anglican Chaplaincy of Bonn and Cologne</span>`;
          }
        })} ${validate_component(NavHamburger, "NavHamburger").$$render($$result, {}, {}, {})} ${validate_component(NavUl, "NavUl").$$render($$result, { activeUrl, class: "cursor-pointer" }, {}, {
          default: () => {
            return `${validate_component(NavLi, "NavLi").$$render($$result, { href: "/" }, {}, {
              default: () => {
                return `Home`;
              }
            })} ${validate_component(NavLi, "NavLi").$$render($$result, { href: "/news" }, {}, {
              default: () => {
                return `News`;
              }
            })} ${validate_component(NavLi, "NavLi").$$render($$result, { href: "/activities" }, {}, {
              default: () => {
                return `Activities`;
              }
            })} ${validate_component(NavLi, "NavLi").$$render($$result, { href: "/groups" }, {}, {
              default: () => {
                return `Groups`;
              }
            ...
            })} ${!$isLoggedIn ? `${validate_component(NavLi, "NavLi").$$render($$result, { href: "/login" }, {}, {
              default: () => {
