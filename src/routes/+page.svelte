<script>
  ...
  const downloadContainerLg =
    "lg:grid lg:grid-cols-4 lg:justify-items-center lg:px-5";
  const downloadContainerXL =
    "xl:grid xl:grid-cols-4 xl:justify-items-center xl:px-5";
</script>
...
{:else}
  ...
  <div
    class={`sectionHeader ${sectionHeader} ${sectionHeaderMd} ${sectionHeaderXl}`}
  >
  ...
  <div class="mb-5 w-full lg:mb-10">
    <div
      class={`item-container ${itemContainer} ${itemContainerLg} ${itemContainerXL}`}
    >
      {#each news as item}
  ...
  <div class="mb-5 w-full lg:mb-10">
    ...
    >
      <div class="download-item mt-10">
        ...
        <div class="circle">
          <span class="icon"
            ><Icon name="sheet" width="24px" height="24px" /></span
          >
        </div>
      </div>
      <div class="download-item mt-10">
