...
export async function signInExistingUser(email: string, password: string): Promise<void> {
    try {
...
export async function registerUser(userData: UserData, password: string): Promise<void> {
    try {
