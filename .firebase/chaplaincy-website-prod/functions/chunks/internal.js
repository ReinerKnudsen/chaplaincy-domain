import { c as create_ssr_component, m as setContext, v as validate_component, p as missing_component } from "./ssr.js";
let base = "";
let assets = base;
...
const options = {
  ...
  templates: {
    app: ({ head, body, assets: assets2, nonce, env }) => '<!DOCTYPE html>\n<html lang="en">\n\n<head>\n	<meta charset="utf-8">\n	<title>Anglican Chaplaincy of Bonn and Cologne</title>\n	<link rel="icon" href="' + assets2 + '/favicon.png">\n	<meta name="viewport" content="width=device-width, initial-scale=1">\n	' + head + '\n</head>\n\n<body data-sveltekit-preload-data="hover">\n	<div style="display: contents">' + body + "</div>\n</body>\n\n</html>",
